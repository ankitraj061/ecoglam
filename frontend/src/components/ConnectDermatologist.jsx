...
const ConnectDermatologist = () => {
  return (
    <section className="w-full max-w-6xl mx-auto px-4 py-12 flex flex-col md:flex-row items-center bg-gradient-to-r from-pink-50 to-purple-50 rounded-2xl shadow-lg">
      {/* Image */}
      <div className="w-full md:w-1/2 mb-8 md:mb-0">
        <img
          src="https://res.cloudinary.com/djbjfsshe/image/upload/v1748130377/der_yzjrka.jpg"
          alt="Dermatologist"
          className="rounded-2xl shadow-md object-cover w-full h-80 md:h-96"
        />
      </div>
      ...
      <div className="w-full md:w-1/2 px-6 flex flex-col justify-center">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">
          Connect with Our Dermatologist
        </h2>
        <p className="text-gray-600 mb-6 text-lg leading-relaxed">
          Have questions about your skincare? Our certified dermatologists are here to help you choose the right products and routine tailored to your skin type.
        </p>
        <div className="flex flex-col sm:flex-row gap-4">
